...
class CircularPercentIndicator extends StatefulWidget {
  ...
  @override
  CircularPercentIndicatorState createState() => CircularPercentIndicatorState();
}
...
class CircularPercentIndicatorState extends State<CircularPercentIndicator>
            ...
            if (widget.widgetIndicator != null && widget.animation)
              Positioned.fill(
                child: Transform.rotate(
                  angle: radians((widget.circularStrokeCap != CircularStrokeCap.butt && widget.reverse)
                  ? -15
                  : 0).toDouble(),
                  child: Transform.rotate(
  ...
  double getCurrentPercent(double percent) {
    if (widget.arcType != null) {
      ...
      final fixedPercent = widget.percent > 0 ? 1.0 / widget.percent * _percent : 0;
      late double margin;
