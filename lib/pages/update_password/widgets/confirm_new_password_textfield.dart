    ...
    return BlocBuilder<UpdatePasswordBloc, UpdatePasswordState>(
      builder: (context, state) {
        return TextField(
          ...
          onChanged: (value) => context.read<UpdatePasswordBloc>().add(UpdateConfirmNewPasswordChanged(value)),
          decoration: InputDecoration(
            ...
            suffixIcon: IconButton(
              ...
              onPressed: () => context.read<UpdatePasswordBloc>().add(UpdateConfirmNewPasswordObscured()),
            )
          )
        );
      }
