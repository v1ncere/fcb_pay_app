...
class InstitutionDisplayBloc extends Bloc<InstitutionDisplayEvent, InstitutionDisplayState> {
  ...
  void _onPaymentInstitutionLoaded(
    InstitutionDisplayLoaded event,
    Emitter<InstitutionDisplayState> emit
  ) async {
    emit(state.copyWith(status: InstitutionDisplayStatus.progress));
  ...
  void _onPaymentInstitutionUpdated(
    InstitutionDisplayUpdated event,
    Emitter<InstitutionDisplayState> emit
  ) async {
